        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
                    <div class="team-item">
                        @foreach($tenagamedis as $doctor)
                        <div class="position-relative rounded-top" style="z-index: 1;">
                            <img class="img-fluid rounded-top w-100" src="{{ asset('medisimg/' . $doctor->image) }}"  alt="">
                        </div>
    ...
    <div class="doctor-list">
        @foreach ($tenagamedis as $doctor)
            <div class="doctor-card">
                <h3>{{ $doctor->nama_medis }}</h3>
                <p><strong>Spesialisasi:</strong> {{ $doctor->spesialisasi_medis }}</p>
                @if($doctor->image)
                    <img src="{{ asset('medisimg/'. $doctor->image)}}" alt="{{$doctor->image}}" width="100">
                @else
                    <p>Tidak ada foto</p>
                @endif
                <!-- Tambahkan tombol untuk detail dokter -->
            </div>
        @endforeach
    </div> --}}
