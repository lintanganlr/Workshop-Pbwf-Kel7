...
@section('content')
        ...
        <!-- Page wrapper  -->
        <!-- ============================================================== -->
        <form action="{{ route('tenagamedis.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="nama_medis" name="nama_medis" class="form-control demo">
                </div>

                <div class="form-group">
                    <label for="spesialisasi_medis">Spesialisasi Medis</label>
                    <input type="text" id="spesialisasi_medis" name="spesialisasi_medis" class="form-control demo">
                </div>
