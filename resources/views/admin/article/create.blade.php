                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" id="tgl_artikel" name="tgl_artikel" class="form-control demo">
                                </div>

                <div class="form-group">
                    <label for="judul_artikel">Judul</label>
                    <input type="text" id="judul_artikel" name="judul_artikel" class="form-control demo">
                </div>
    ...
    <div class="col-sm-10">
        ...
        @enderror
                ...
                <div class="form-group">
                    ...
                    <textarea  id="deskripsi" name="deskripsi" class="form-control demo"></textarea>
                </div>
                {{-- <div class="row">
                    <div class="col-12">
                        <div class="card">
