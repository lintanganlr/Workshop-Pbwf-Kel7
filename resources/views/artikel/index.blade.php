    ...
    <div class="container">
        <div class="row g-5">
            ...
            <div class="col-lg-4 mb-4">
                <div class="position-relative">
                    <img class="img-fluid rounded-top" src="{{ asset('artikelimg/' . $artikel->image) }}" alt="{{ $artikel->judul_artikel }}">
                    <div class="position-relative text-center bg-light border-bottom border-primary py-5 p-4">
                        <h4>{{ $artikel->judul_artikel }}</h4>
                        <a href="{{ route('artikel.tampilan', $artikel->judul_artikel) }}" class="btn btn-primary py-2 px-4">Baca Selengkapnya</a>
                    </div>
                </div>
            </div>
            @endforeach
