                        ...
                        <div class="card-body">
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('register.submit') }}">
                                    ...
                                    <div class="row mb-3">
                                        <label for="notelp" class="col-md-4 col-form-label text-md-end">{{ __('Phone Number') }}</label>
                                    ...
                                    <div class="row mb-0">
                                        <div class="col-md-6 offset-md-4">
                                            <button type="submit" class="btn btn-primary"style="background-color: #7D1219;margin-top:10px;">
                                                {{ __('Register') }}
                                            </button>
                                        </div>
                                    </div>
